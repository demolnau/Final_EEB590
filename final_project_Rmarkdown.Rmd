...
PCoA<-cmdscale(Y.dist.matrix)   #from vegan
```
...
model2.rrpp <- lm.rrpp(Y.dist.matrix ~ mydat$Group_2 * mydat$Habitat * mydat$Country, print.progress = FALSE)
anova(model2.rrpp)
```
...
#posthoc <- pairwise(fit = model2.rrpp , groups = mydat$Group_2, print.progress = FALSE)
#summary(posthoc)
